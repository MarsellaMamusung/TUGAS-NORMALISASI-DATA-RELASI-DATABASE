...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Nov 2023 pada 06.58
...
ALTER TABLE `detail_penjualan`
  ...
  ADD KEY `qty_penjualan` (`qty_penjualan`);
...
ALTER TABLE `detail_penjualan`
  ...
  ADD CONSTRAINT `detail_penjualan_ibfk_3` FOREIGN KEY (`no_jual`) REFERENCES `penjualan_barang` (`no_jual`) ON DELETE CASCADE ON UPDATE CASCADE;
